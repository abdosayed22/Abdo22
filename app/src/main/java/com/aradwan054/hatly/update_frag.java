...
public class update_frag extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
      ...
      final   EditText name , phone , address ,password ;
        name = (EditText) view.findViewById(R.id.name);
        phone = (EditText)view.findViewById(R.id.phone);
        address = (EditText)view.findViewById(R.id.address);
        Button up = (Button) view.findViewById(R.id.updatebtn);
        final ImageView image = (ImageView)view.findViewById(R.id.changedImage);
        ...
        up.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String id = FirebaseAuth.getInstance().getCurrentUser().getUid();
                myRef = database.getReference("Accounts");
                myRef.child(id).child("UserName").setValue(name.getText().toString());
                myRef.child(id).child("Phone").setValue(phone.getText().toString());
                myRef.child(id).child("address").setValue(address.getText().toString());
